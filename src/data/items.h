...
// Mail
    ...
    [ITEM_RUBY_MAIL] =
    {
        ...
        .price = 50,
        .description = sRubyMailDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_MAIL,
        .fieldUseFunc = ItemUseOutOfBattle_Mail,
        .secondaryId = ITEM_TO_MAIL(ITEM_RUBY_MAIL),
    },
    ...
    [ITEM_EMERALD_MAIL] =
    {
        ...
        .price = 50,
        .description = sEmeraldMailDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_MAIL,
        .fieldUseFunc = ItemUseOutOfBattle_Mail,
        .secondaryId = ITEM_TO_MAIL(ITEM_EMERALD_MAIL),
    },
    ...
    [ITEM_RED_MAIL] =
    {
        ...
        .price = 50,
        .description = sFireMailDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_MAIL,
        .fieldUseFunc = ItemUseOutOfBattle_Mail,
        .secondaryId = ITEM_TO_MAIL(ITEM_RED_MAIL),
    },
    ...
    [ITEM_GREEN_MAIL] =
    {
        ...
        .price = 50,
        .description = sLeafMailDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_MAIL,
        .fieldUseFunc = ItemUseOutOfBattle_Mail,
        .secondaryId = ITEM_TO_MAIL(ITEM_GREEN_MAIL),
    },
    ...
    [ITEM_BLUE_MAIL] =
    {
        ...
        .type = ITEM_USE_MAIL,
        .fieldUseFunc = ItemUseOutOfBattle_Mail,
        .secondaryId = ITEM_TO_MAIL(ITEM_BLUE_MAIL),
    },

    [ITEM_SAPPHIRE_MAIL] =
    {
        .name = _("SAPPHIRE MAIL"),
        .itemId = ITEM_SAPPHIRE_MAIL,
        .price = 50,
        .description = sSapphireMailDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_MAIL,
        .fieldUseFunc = ItemUseOutOfBattle_Mail,
        .secondaryId = ITEM_TO_MAIL(ITEM_SAPPHIRE_MAIL),
    },
...
// Emerald-specific key items
    ...
    {
        .name = _("MAGMA CUFF"),
        .itemId = ITEM_MAGMA_BRACER,
        .price = 0,
        .description = sMagmaCuffDesc,
        .importance = 1,
        .registrability = TRUE,
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_BAG_MENU,
	...
	[ITEM_AQUA_NECKLACE] =
    {
        .name = _("AQUA NECKLACE"),
        .itemId = ITEM_AQUA_NECKLACE,
        .price = 0,
        .description = sAquaNecklaceDesc,
        .importance = 1,
        .registrability = TRUE,
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_BAG_MENU,
    ...
    {
        .name = _("TEMPEST PIN"),
        .itemId = ITEM_TEMPEST_PIN,
        .price = 0,
        .description = sTempestPinDesc,
        .importance = 1,
        .registrability = TRUE,
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_BAG_MENU,
    ...
    {
        .name = _("FLAME BROOCH"),
        .itemId = ITEM_FLAME_BROOCH,
        .price = 0,
        .description = sFlameBroochDesc,
        .importance = 1,
        .registrability = TRUE,
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_BAG_MENU,
    ...
    {
        .name = _("IVY BAND"),
        .itemId = ITEM_IVY_BAND,
        .price = 0,
        .description = sIvyBandDesc,
        .importance = 1,
        .registrability = TRUE,
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_BAG_MENU,
    ...
    {
        .name = _("OCEAN ANKLET"),
        .itemId = ITEM_OCEAN_ANKLET,
        .price = 0,
        .description = sOceanAnkletDesc,
        .importance = 1,
        .registrability = TRUE,
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_BAG_MENU,
