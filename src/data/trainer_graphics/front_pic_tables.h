const struct MonCoords gTrainerFrontPicCoords[] =
{
	...
	[TRAINER_PIC_FORTUNE_TELLER] = {.size = 8, .y_offset = 1},
};
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
	...
	TRAINER_SPRITE(FORTUNE_TELLER, gTrainerFrontPic_FortuneTeller, TRAINER_PIC_SIZE),
};
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
	...
	TRAINER_PAL(FORTUNE_TELLER, gTrainerPalette_HexManiac),
};
