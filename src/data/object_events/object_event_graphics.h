...
const u16 gObjectEventPal_ShinyLatios[] = INCBIN_U16("graphics/object_events/palettes/s_latios.gbapal");
const u16 gObjectEventPal_ShinyLatias[] = INCBIN_U16("graphics/object_events/palettes/s_latias.gbapal");
const u16 gObjectEventPal_ShinyLatiosReflection[] = INCBIN_U16("graphics/object_events/palettes/s_latios_reflec.gbapal");
const u16 gObjectEventPal_ShinyLatiasReflection[] = INCBIN_U16("graphics/object_events/palettes/s_latias_reflec.gbapal");
const u32 gObjectEventPic_FortuneTeller[] = INCBIN_U32("graphics/object_events/pics/people/fortune_teller.4bpp");
const u32 gObjectEventPic_HumanLatios[] = INCBIN_U32("graphics/object_events/pics/people/latios_human.4bpp");
const u32 gObjectEventPic_HumanLatias[] = INCBIN_U32("graphics/object_events/pics/people/latias_human.4bpp");
const u16 gObjectEventPal_HumanLatiosS[] = INCBIN_U16("graphics/object_events/palettes/shiny_human_latios.gbapal");
const u16 gObjectEventPal_HumanLatiasS[] = INCBIN_U16("graphics/object_events/palettes/shiny_human_latias.gbapal");
const u32 gObjectEventPic_HumanLatiosC[] = INCBIN_U32("graphics/object_events/pics/people/latios_human_colorless.4bpp");
const u32 gObjectEventPic_HumanLatiasC[] = INCBIN_U32("graphics/object_events/pics/people/latias_human_colorless.4bpp");
const u16 gObjectEventPal_HumanLatiosC[] = INCBIN_U16("graphics/object_events/pics/people/latios_human_colorless.gbapal.lz");
const u16 gObjectEventPal_HumanLatiasC[] = INCBIN_U16("graphics/object_events/pics/people/latias_human_colorless.gbapal.lz");
