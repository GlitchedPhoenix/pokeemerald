...
const u16 gObjectEventPal_MagmaGruntF[] = INCBIN_U16("graphics/object_events/palettes/magma_grunt_f.gbapal");
...
const u16 gObjectEventPal_Breeder[] = INCBIN_U16("graphics/object_events/pics/people/breeder_f.gbapal");
