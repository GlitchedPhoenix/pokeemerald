...
// Assigns all species to the Hoenn Dex Index (Summary No. for Hoenn Dex)
static const u16 sSpeciesToExtendedPokedexNum[NUM_SPECIES - 1] =
{
...
// Assigns all Extended Dex Indexes to a National Dex Index
static const u16 sExtendedToNationalOrder[NUM_SPECIES - 1] =
{
    ...
    // End of Extended Dex (see EXTENDED_TO_NATIONAL(COUNT)
...
static const u16 sDeoxysLevelUpLearnsets[][15] = {
    { //Normal Forme
        ...
        LEVEL_UP_MOVE(10, MOVE_NIGHT_SHADE), // for whatever reason Deoxys got Teleport in his encounter which broke the event, so it's now only in A/D form movesets because I'm lazy. who catches a Deoxys so they can use Teleport, anyway?
...
s32 CalculateBaseDamage(struct BattlePokemon *attacker, struct BattlePokemon *defender, u32 move, u16 sideStatus, u16 powerOverride, u8 typeOverride, u8 battlerIdAtk, u8 battlerIdDef)
{
    ...
    if (ShouldGetStatBadgeBoost(FLAG_BADGE05_GET, battlerIdDef))
        defense = (badgeBoostMultiplier * defense) / 100;
...
u16 ExtendedPokedexNumToSpecies(u16 extendedNum)
{
    u16 species;
    ...
    while (species < (NUM_SPECIES - 1) && sSpeciesToExtendedPokedexNum[species] != extendedNum)
        species++;
...
u16 ExtendedToNationalOrder(u16 hoennNum)
{
    ...
    return sExtendedToNationalOrder[hoennNum - 1];
}
...
u16 SpeciesToPokedexNum(u16 species)
{
	...
	else if (FlagGet(FLAG_SYS_EXTENDED_DEX))
	{
