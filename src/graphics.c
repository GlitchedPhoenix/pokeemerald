...
const u32 gSummaryPage_IV_EV_Tilemap[]        = INCBIN_U32("graphics/summary_screen/page_ivev.bin.lz");
...
const u32 gTitleScreenEmeraldVersionPal[]  = INCBIN_U32("graphics/title_screen/emerald_version.gbapal");
