...
const u8 gText_IVEVSummary[] = _("IVs/EVs");
...
const u8 gText_MainMenuExtraOptions[] = _("EXTRA OPTIONS");
const u8 gText_ExtraOptions[] = _("{COLOR GREEN}EXTRA OPTIONS");
...
const u8 gText_TotalStat[] = _("TOTAL");
...
const u8 gText_DexExtendedTitle[] = _("EXTENDED DEX");
...
const u8 gText_DexExtendedDescription[] = _("HOENN's expanded POKéDEX");
...
const u8 gText_Difficulty[] = _("{COLOR GREEN}DIFFICULTY");
const u8 gText_Nuzlocke[] = _("{COLOR GREEN}NUZLOCKE");
const u8 gText_MotherMode[] = _("{COLOR GREEN}MOTHER MODE");
const u8 gText_DoublesMode[] = _("{COLOR GREEN}DOUBLES ONLY");
const u8 gText_MultiControl[] = _("{COLOR GREEN}MULTI CONTROL");
...
const u8 gText_Option[] = _("{COLOR GREEN}OPTIONS");
const u8 gText_TextSpeed[] = _("{COLOR GREEN}TEXT SPEED");
const u8 gText_BattleScene[] = _("{COLOR GREEN}BATTLE SCENE");
...
const u8 gText_TextSpeedFast[] = _("{COLOR DARK_GRAY}{SHADOW LIGHT_GREEN}FAST");
const u8 gText_BattleSceneOn[] = _("{COLOR DARK_GRAY}{SHADOW LIGHT_GREEN}ON");
const u8 gText_BattleSceneOff[] = _("{COLOR DARK_GRAY}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_BattleStyleShift[] = _("{COLOR DARK_GRAY}{SHADOW LIGHT_GREEN}SHIFT");
const u8 gText_BattleStyleSet[] = _("{COLOR DARK_GRAY}{SHADOW LIGHT_GREEN}SET");
const u8 gText_SoundMono[] = _("{COLOR DARK_GRAY}{SHADOW LIGHT_GREEN}MONO");
const u8 gText_SoundStereo[] = _("{COLOR DARK_GRAY}{SHADOW LIGHT_GREEN}STEREO");
const u8 gText_FrameType[] = _("{COLOR DARK_GRAY}{SHADOW LIGHT_GREEN}TYPE");
const u8 gText_FrameTypeNumber[] = _("{COLOR DARK_GRAY}{SHADOW LIGHT_GREEN}");
const u8 gText_ButtonTypeNormal[] = _("{COLOR DARK_GRAY}{SHADOW LIGHT_GREEN}NORMAL");
const u8 gText_ButtonTypeLR[] = _("{COLOR DARK_GRAY}{SHADOW LIGHT_GREEN}LR");
const u8 gText_ButtonTypeLEqualsA[] = _("{COLOR DARK_GRAY}{SHADOW LIGHT_GREEN}L=A");
...
const u8 gText_Easy[] = _("{COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR3}EASY     ");
const u8 gText_NormalDifficulty[] = _("{COLOR DYNAMIC_COLOR5}{SHADOW DYNAMIC_COLOR6}NORMAL");
const u8 gText_ChallengeDifficulty[] = _("{COLOR RED}{SHADOW LIGHT_RED}HARD     ");
const u8 gText_Brutal[] = _("{COLOR BLUE}{SHADOW LIGHT_BLUE}BRUTAL");
const u8 gText_Unfair[] = _("{COLOR DYNAMIC_COLOR2}{SHADOW DYNAMIC_COLOR1}UNFAIR");
...
const u8 gText_ExplainInverseMode[] = _("{COLOR DARK_GRAY}{SHADOW LIGHT_GREEN}Reverses all type effectiveness. For\nexample, {COLOR LIGHT_RED}{SHADOW RED}Fire{COLOR DARK_GRAY}{SHADOW LIGHT_GREEN} would now beat {COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}Water{COLOR DARK_GRAY}{SHADOW LIGHT_GREEN}\lbut be weak to {COLOR DYNAMIC_COLOR3}{SHADOW DYNAMIC_COLOR4}Grass{COLOR DARK_GRAY}{SHADOW LIGHT_GREEN}.");
const u8 gText_ExplainBadgeBoosts[] = _("{COLOR DARK_GRAY}{SHADOW LIGHT_GREEN}Toggles whether or not badge boosts\nwill be applied. Keep in mind that on\l{COLOR DYNAMIC_COLOR4}{SHADOW DYNAMIC_COLOR3}Easy{COLOR DARK_GRAY}{SHADOW LIGHT_GREEN}, the badge stat multiplier is\lraised from 1.1x to 1.2x.$");
