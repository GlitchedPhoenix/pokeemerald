...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
	...
	[MAPSEC_GREENLEAF_RESERVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_ASHEN_RANGE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_COMET_VALLEY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE
};
