...
#define BERRY_TREE_BATTLE_FRONTIER_GANLON 90
#define BERRY_TREE_SOUTHERN_ISLAND_PETAYA 91
#define BERRY_TREE_SOUTHERN_ISLAND_APICOT 92
#define BERRY_TREE_FARAWAY_ISLAND_ENIGMA 93
#define BERRY_TREE_COMET_VALLEY_SALAC 94
